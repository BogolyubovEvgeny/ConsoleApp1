...
//Плюсы
//Устранение ошибок
//Экономия времени, устранение ошибок экономит время
//При изменении кода можно удостоверится что все работает нормально
//Тесты помогают разобраться в коде другим участникам проекта
//Упрощение устранения ошибок

//Минусы
//Написание тестов занимает время
//При изменении кода требуется обновление тестов
//Не гарантирует что ошибок не будет
//Код может быть сложным для написания тестов
